...
def run_validation(forceobj=True):
    ...
    test_name = 'run_2_LGCN-fully-supervised_data-citeseer_dropout-0.2_weight-decay-0.0_num_layer-4_hidden-dim-32_backtrack-True'
    ...
    line_graphs, features, labels, num_classes, n_feats, lg_node_list, train_mask, test_mask, valid_mask = \
        DGLDatasetReader(dataset_name=dataset_name)
